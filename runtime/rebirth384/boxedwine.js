...
var ASM_CONSTS = {
 ...
 335535: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 335618: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 335687: () => { return window.innerWidth; },  
 335717: () => { return window.innerHeight; },  
 335748: ($0, $1) => { alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1)); }
};
